      ...
      >
        {
          history.map((item, index) => (
            <Animated.View key={item.id} entering={SlideInRight} exiting={SlideOutRight} layout={Layout.springify()}>
              <Swipeable ref={(ref) => {
                if(ref){
                ...
                overshootLeft={false} containerStyle={styles.swipeableContainer} renderLeftActions={() => (
